    ...
    */
    ...
    return (
        <div>
            ...
            {!iscreating && (isNaN(quantity) || isNaN(decimals)) &&
                <div>
                    <button className="mt-[40px] flex w-[178px] bg-gray border border-white/50 rounded-md border-dashed items-center text-[20px] text-white/50 font-bold py-[14px] px-[24px]" disabled>Create token</button>
                    <p className="mt-5">❌ Please fill in both fields with a number</p>
                </div>
            }

            {iscreating &&
                <button className="btn btn-primary uppercase text-white mt-[20px]">
